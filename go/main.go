...
func monsters() {
	...
	http.HandleFunc("/monsters/", func(w http.ResponseWriter, r *http.Request) {
		...
		if error404("/monsters/"+mresponse[index].Name, w, r) == true {
			errorHandler(w, r, http.StatusNotFound)
		} else {
...
func items() {
	...
	http.HandleFunc("/items/", func(w http.ResponseWriter, r *http.Request) {
		...
		if error404("/items/"+iresponse[index].Name, w, r) == true {
			errorHandler(w, r, http.StatusNotFound)
		} else {
...
func weapons() {
	...
	http.HandleFunc("/weapons/", func(w http.ResponseWriter, r *http.Request) {
		...
		if error404("/weapons/"+wresponse[index].Name, w, r) == true {
			errorHandler(w, r, http.StatusNotFound)
		} else {
...
func armors() {
	...
	http.HandleFunc("/armors/", func(w http.ResponseWriter, r *http.Request) {
		...
		if error404("/armors/"+aresponse[index].Name, w, r) == true {
			errorHandler(w, r, http.StatusNotFound)
		} else {
...
func foods() {
	...
	http.HandleFunc("/foods/", func(w http.ResponseWriter, r *http.Request) {
		...
		if error404("/foods/"+fresponse[index].Name, w, r) == true {
			errorHandler(w, r, http.StatusNotFound)
		} else {
...
func skills() {
	...
	http.HandleFunc("/skills/", func(w http.ResponseWriter, r *http.Request) {
		...
		if error404("/skills/"+sresponse[index].Name, w, r) == true {
			errorHandler(w, r, http.StatusNotFound)
		} else {
